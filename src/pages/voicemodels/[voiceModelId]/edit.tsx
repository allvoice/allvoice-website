...
import NPCPickerEdit from "~/components/npc-picker-edit";
...
const VoiceEdit: NextPage<ServerProps> = (serverProps) => {
  ...
  const isNPCSelected = useMemo(() => {
    const uniqueWarcraftNpcName = workspace.data?.uniqueWarcraftNpcName;
    const warcraftDisplayName = workspace.data?.warcraftDisplayName;
    return (
      uniqueWarcraftNpcName !== undefined || warcraftDisplayName !== undefined
    );
  }, [
  ...
  const generateTestSound = api.voices.generateTestSound.useMutation({
    onSettled() {
      void utils.users.syncUser.invalidate();
    },
  });
                ...
                render={({ field }) => (
                  <FormItem>
                    <div className="flex items-center space-x-1">
                      ...
                      <InfoPopover>
                        <p className="text-sm">
                          English was trained on American and British
                          audiobooks. Multilingual is capable of more accents
                    ...
                    <div className="flex items-center space-x-1">
                      ...
                      <InfoPopover>
                        <p className="text-sm">
                          ...
                          with output varying between re-generations. It can
